...
/**
 * Set the threadId for the notification
 * @param {String} [threadId] The threadId for the push notification action
 */
Notification.prototype.setThreadId = function (threadId) {
...
Notification.prototype.apsPayload = function() {
	...
	aps.category = this.category || aps.category;
        ...
        aps["thread-id"] = this.threadId || aps["thread-id"];
